...
<div>
<div class="you-can-search">YOU CAN SEARCH FOR</div><div class="search-menu-placeholder search-desc-placeholder"><div class="search-cat"><i class="fa fa-globe search-placeholder-icon"></i><div class="section-name"> Stores </div></div><div class="search-name">eg. Paytm, Domino's, Flipkart...</div></div><div class="search-menu-placeholder search-desc-placeholder"><div class="search-cat"><i class="fa fa-cubes search-placeholder-icon"></i><div class="section-name"> Categories </div></div><div class="search-name">eg. Recharge, Pizza, Flights...</div></div></div></div><div class="recent-search-div"></div></div>

<div class="header-user-profile" id="user-profile"><img class="header-user-pic" src="https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=50" alt="profile pic"><div class="header-user-detils"><div class="header-user-name">Ayush Gupta</div><span class="cb-text flat-green"><span class="ico"></span><span class="header-user-cashback-amt">Rs. 0</span></span><i class="fa fa-angle-down header-angle-down" id="lowarrow"></i></div></div>


<div class="user-profile-dropdown" id="user-profile-dropdown"  style='display:none'><div></div><div class="wallet-details"><div class="bal-details"><span class="bal-bold">Pending</span><span class="bal-txt">Balance</span></div><div class="bal-amt-pending"><span class="cb-text grey"><span class="ico"></span><span>Rs. 0</span></span></div><div class="bal-details-avail"><span class="bal-bold">Available</span><span class="bal-txt">Balance</span></div><div class="bal-amt-pending"><span class="cb-text"><span class="ico"></span><span>Rs. 0</span></span></div></div><div class="profile-links-wrapper"><a href="/cashback/overviewcash.php" data-gtm="Overview"><div class="profile-link"><span class="prof-icon"><div class="header-footer-sprite user-overview"></div></span><span class="link-txt">Overview</span></div></a><a href="/profile/transfer" data-gtm="Transfer Money"><div class="profile-link"><span class="prof-icon"><div class="header-footer-sprite user-payment"></div></span><span class="link-txt">Withdraw Money</span></div></a><a href="/profile/activity" data-gtm="Cashback Activity"><div class="profile-link"><span class="prof-icon"><div class="header-footer-sprite user-activity"></div></span><span class="link-txt">Cashback Activity</span></div></a><a href="/profile/refer" data-gtm="Refer &amp; Earn"><div class="profile-link"><span class="prof-icon"><div class="header-footer-sprite refer-earn"></div></span><span class="link-txt">Refer &amp; Earn </span></div></a><a href="/profile/settings/info" data-gtm="Profile &amp; Settings"><div class="profile-link"><span class="prof-icon"><div class="header-footer-sprite user-settings"></div></span><span class="link-txt">Profile &amp; Settings</span></div></a><a href="/profile/support" data-gtm="Help &amp; Support"><div class="profile-link"><span class="prof-icon"><div class="header-footer-sprite help-support"></div></span><span class="link-txt">Help &amp; Support</span></div></a><a href="logout.php"><div class="profile-link" id="sign-out"><span class="prof-icon"><div class="header-footer-sprite user-logout"></div></span><span class="link-txt">Logout</span></div></a></div></div>
...
<ul class="filter-list">
    ...
    <div>
        ...
        <span class="tag">Home & Furniture(9)</span>
    </div>
...
<?php
    ...
    foreach ($products as $product){
            //Keep count.
            if($product['category']=="Mobiles & Tablets"){
            if($count2<=15){
            $count2++;
...
<section class="still-earn-cashback">
   <div class="still-earn-cashback-text">
      ...
      <div class="still-earn-cashback-btn">Earn Rewards on Flipkart</div>
   </div>
</section>
         ...
         <div class="md-content">
            <div class="cd-modal-content">
               <div class="cd-modal-body">
                  ...
                  <div class="btn-holder"><span class="btn-type md-close" data-aff-id="1">Flipkart-DESKTOP</span></div>
               </div>
            </div>
         </div>
      </form>
                  ...
                  <div class="cb-rates-content">
                     <table>
                        <tbody>
                           ...
                           <tr>
                              <td rowspan="1"> Flipkart First Subscription, Value Added Services, Any product/category not mentioned with cashback </td>
                              <td rowspan="1"> Any </td>
                              <td rowspan="1"> 0 % </td>
                           </tr>
                           <tr>
                              <td rowspan="1"> Gemstones, Gold &amp; Silver Coins, Flipkart Gift Card, Mobile Phones (Category B): Redmi Note 4, Redmi 4A, Redmi 5A, Mi A1, Redmi Note 5, Redmi Note 5 Pro, Apple iPhones, Honor 9 Lite, Infinix Hot S3, Mi Smart LED TVs </td>
                              <td rowspan="1"> Any </td>
