...
<div class="header-user-profile" id="user-profile">
                ...
                <div class="header-user-detils">
                    ...
                    <span class="header-user-cashback-amt">Rs. 0</span></span><i class="fa fa-angle-down header-angle-down"></i>
                </div>
            </div>
<?php } ?>
...
<div class="sign-up signup-link">SIGN UP</div></a>
<div class="sign-up-ctr"><div class="navbar-new-user-text">Existing User?</div>
<a href="#mymodal" data-toggle="modal" data-target="#mymodal">
<div class="log-in signin-link">Log In</div></a>
</div>
</div>
</div>
</div>
