    ...
    function checkUser($userData = array()){
        if(!empty($userData)){
            ...
            if($prevResult->num_rows > 0){
                ...
                $query1 = "INSERT INTO ".$this->cash." SET email = '".$userData['email']."',cash='0'";
                $query2 = "INSERT INTO ".$this->cashback." SET Useremail = '".$userData['email']."',amount ='0' ";
                $ins = $this->db->query($query1);
                $ins2 = $this->db->query($query2);
            ...
            $cashquery = "SELECT * FROM ".$this->cash."WHERE email = '".$userData['email']."'";
        }
