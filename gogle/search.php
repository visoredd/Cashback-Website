...
if(!isset($q)){
    ...
    $projects = array();
    $records = $mysqli->query("SELECT * FROM amazon WHERE description LIKE '%$q%' OR title LIKE '%$q%' UNION SELECT * FROM flipkart WHERE description LIKE '%$q%' OR title LIKE '%$q%' UNION SELECT * FROM amazon_beauty WHERE description LIKE '%$q%' OR title LIKE '%$q%' UNION SELECT * FROM amazon_fitness WHERE description LIKE '%$q%' OR title LIKE '%$q%' UNION SELECT * FROM amazon_computer WHERE description LIKE '%$q%' OR title LIKE '%$q%' UNION SELECT * FROM amazon_mobiles WHERE description LIKE '%$q%' OR title LIKE '%$q%' UNION SELECT * FROM amazon_books WHERE description LIKE '%$q%' OR title LIKE '%$q%' UNION SELECT * FROM flipkart_api2 WHERE description LIKE '%$q%' OR title LIKE '%$q%' ");
    while ($project =  mysqli_fetch_array($records))
    {
        $projects[] = $project;
    }
                     ...
                     <div class="offer-card-holder" data-offer-key="isCashback" data-offer-value="1">
                        ...
                        <div class="card-content-top" data-offer-key="mobileCashbackValue" data-offer-value="0.07%">
                           ...
                           <div class="horizontal_online_content" data-offer-key="cashbackType" data-offer-value="REWARDS">
                              <a href="https://www.coupondunia.in/flipkart" class="cHide"><span class="store-name"> Flipkart </span></a>
                              <a href="display.php?data=<?php echo $project['description']; ?>&data2= <?php echo $project['link']; ?>">
                                 <div class="offer-title offer-get-code-link"> <?php echo $project['title']?> | <?php echo $project['description']?> </div>
                              </a>
