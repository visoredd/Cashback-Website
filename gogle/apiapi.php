...
$offerJsonURL =  'https://affiliate-api.flipkart.net/affiliate/1.0/feeds/shahrusha1/category/7jv.json?expiresAt=1521946592690&sig=533d27b71d3035fe5db74408615cc161';
$dotdJsonURL =  'https://affiliate-api.flipkart.net/affiliate/offers/v1/dotd/json';
$rawraw = 'https://affiliate-api.flipkart.net/affiliate/1.0/feeds/rawfiles/<category>';
...
<h1 style="text-align:center">FlipKart Affiliate API DEMO</h1>
    ...
    <?php foreach($result['products'] as $resultS) { 
        foreach($resultS['productBaseInfoV1'] as $resultSet){
  
?>
        <div class="item col-sm-6 col-md-3"  cat="<?= $resultSet['productDescription']; ?>">
            <div class="thumbnail" >
