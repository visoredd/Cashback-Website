...
<a class="navbar-brand" href="/cashback/gogle/zumyi.php"><div>CASHBACK
</div>
</a>
            ...
            <div class="profile-sidebar">
                <div class="profile-info border-bottom-grey">
                    ...
                    <div class="profile-user-name"> <?php echo $userData['first_name']; ?>
                        ...
                        <div class="profile-user-pending-amt">Pending: <span>Rs. <?php echo $pen ?> </span>
                        </div>
                    </div>
                </div>
                <div id="sidetabs" class="profile-tabs">
                    <div class="sidetab">
                        <a class="router-link-active">
                            <div>
                                <div class="itag profile-sprite">
                                </div>
                                <span class="innerSpan" style="color : #6C747F; font-weight: normal "> Overview </span>
                            </div>
                        </a>
                    </div>
                    <div class="sidetab">
                        <a href="/profile/transfer">
                            <div>
                                ...
                                <span class="innerSpan" style="color : black; font-weight: bold "> Withdraw Money </span>
                            </div>
                        </a>
                    </div>
                    <div class="sidetab">
